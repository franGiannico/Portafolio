            ...
            <section className="about-us section-container">          
                <div className="content-wrapper">
                    <article className="about-item">
                        ...
                        <div>
                            <h2>Sobre mí</h2>
                            <p>Me motiva mucho aprender y entender cómo funcionan las cosas. Curioso por naturaleza, me gusta desarmar cosas hasta entender el funcionamiento de sus sistemas.<br></br>
                    ...
                    <article className="about-item">
                        ...
                        <div>
                            <h2>Herramientas</h2>
                            <p>React: creación de componentes reutilizables, creación y manipulación de rutas, consumir APIs, hooks, actualización de estados. / JavaScript:
